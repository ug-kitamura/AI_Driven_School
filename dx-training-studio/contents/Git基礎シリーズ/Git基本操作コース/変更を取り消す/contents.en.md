<!-- source: sha256:b4a648e0f0b058876d8c5b599191dddd413b58945b96f5b976b26e6400258679 -->
...
`init`, `status`, `add`, `commit`, `log`, `diff`, `restore` — you have now typed all seven of the operations promised in the first lesson of the series, with your own hands. Nicely done. **The Git Fundamentals series is cleared.** "I can save my work at any time, and safely go back to it" — the weapon promised in the first lesson is already in your hands.

On the Mandala, the next quest — the **GitHub Fundamentals series** — has been unlocked. That series covers how to share a repository with your team and how to work together using branches.
