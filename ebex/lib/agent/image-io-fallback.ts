/** スキル本文に含まれる場合、EBEX は画像・マルチモーダル入出力に非対応としてユーザーへ選択を促す */
...
export const IMAGE_IO_FALLBACK_USER_MESSAGE =
  "EBEX は画像・マルチモーダルの生成/読取に対応していません。該当処理をスキップして続行するか、中止するかを選んでください。";

export const IMAGE_IO_FALLBACK_MODEL_HINT =
  "EBEX は画像・マルチモーダルの生成/読取に対応していない。当該処理はユーザーの選択によりスキップされている。テキストで完結する範囲の作業を続行すること。";
