...
const PANE4_TOP_BOX_MIN_H = "min-h-[96px]";
const PANE4_TOP_BOX_CLASS = cn(
  PANE4_TOP_BOX_MIN_H,
  "flex flex-col items-center justify-center rounded-lg border-2 border-dashed p-4 text-center",
);
const PANE4_PROMPT_TEXTAREA_CLASS = cn(
  PANE4_TOP_BOX_MIN_H,
  "w-full resize-y rounded-lg border border-border bg-background px-3 pt-2 pb-3 text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary",
);
